...
<div class="content">
  <ul class="breadcrumb">
    ...
    <li><a href="#" class="active">Call Center Briefing</a> </li>
  </ul>
  <div class="row-fluid">
    <div class="span12">
      ...
      <div class="grid simple ">
        <div class="grid-title">
          <h4>Call Center Briefing Export</h4>
          <a href="{{url('report/call-center-briefing')}}" style="display:none" target="_blank" id="call-center-download">Download</a>
        ...
        <div class="grid-body ">
          ...
          <div class="channelForm" id="channelForm">
            <!-- export form -->
            <form class="form-no-horizontal-spacing" id="call_center_export_form" data-controller="report" data-type="normal" data-method="export-call-center">
              ...
              <div class="row form-row">
                ...
                <div class="col-md-4">
                  ...
                  <select name="language" id="language" class="select2 form-control">
                    <option value="">Select Below</option>
                    <option value="german"
                    @if(old('language') == "german")
                      selected="selected"
                    @endif
                    >German</option>
                    <option value="english"
                    @if(old('language') == "english")
                      selected="selected"
                    @endif
                    >English</option>
                  </select>
                ...
                <div class="col-md-4">
                  ...
                  <select name="placement_ids[]" id="call_center_placement" class="select2 form-control" multiple="multiple">
                    @include('reports.exports.call_center_project_placements')
                  </select>
                </div>
              ...
              <div class="row form-row">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control date" placeholder="Date From" name="date_from" id="date_from" value="{{ old('date_from') }}">
                  <span class="error">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control date" placeholder="Date Until" name="date_until" id="date_until" value="{{ old('date_until') }}">
                  <span class="error">
