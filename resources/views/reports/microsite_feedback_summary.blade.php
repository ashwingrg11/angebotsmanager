<div class="content">
  <ul class="breadcrumb">
    ...
    <li><p>Reporting</p></li>
    <li><a href="#" class="active">Microsite Feedback</a> </li>
  </ul>
  <div class="row-fluid">
    <div class="span12">
      ...
      <div class="grid simple ">
        <div class="grid-title">
          ...
          <h4><span class="semi-bold">Microsite Feedback Summary</span></h4>
          <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#grid-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
        </div>
        <div class="grid-body ">
          <table class="table datatable" id="microsite_feedback_table" data-page-length='50'>
            <thead>
              <tr>
            ...
            @foreach($offer_reports as $offer_report)
              <tr>
                <td>
                  <a href="javascript:;" class="body-link" style="cursor:pointer" data-controller="report" data-mode="show" data-param="{{ $offer_report->id }}">
...
<script type="text/javascript">
  $(function(){
    ...
    $('#microsite_feedback_table tfoot th').each( function () {
      var title = $('#microsite_feedback_table thead th').eq( $(this).index() ).text();
      $(this).html( '<input type="text" placeholder="Search '+title+'" />' );
    } );
    // DataTable
    var table = $('#microsite_feedback_table').DataTable();
    // Apply the search
    ...
    // $('#microsite_feedback_table tfoot th input').eq(8).hide();
  })
</script>