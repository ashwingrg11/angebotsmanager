  ...
  <div class="container">
    ...
    <div class="row maincontent">
      ...
      <div class="col-md-9" style="padding:0px;">
        <p class="color1">Wir bedanken uns vorab für Ihre Teilnahme an unserer finalen Umfrage. Ihr Feedback ist uns sehr wichtig, denn Ihre Antworten helfen uns bei der Weiterentwicklung des Kundenvorteilsprogramms.</p>
      </div>
      <!--microsite 2 form starts-->
      <form action="" class="form-horizontal" method="post">
      <div class="col-md-9 feedback" style="padding:0px; margin-top:2%;">
        <label for="inquiries">Sind Sie an weiteren Kooperationen mit dem Journal International Verlag für andere Publikationen in Zukunft interessiert?</label>
        <!--future collaboration-->
        <div class="form-group">
          <div class="form-yesno" style="font-size:125%;">
            <div class="row">
              <label for="yesno-radio1" class="label-yes">Ja</label>
              <div class="checkBox">
            ...
            <div class="row">
              <label for="yesno-radio2" class="label-no">Nein</label>
              <div class="checkBox">
          ...
          <div class="form-yesno-area">
            <textarea name="future_collaboration_text" class="form-control microsite-textarea" id="" rows="3" style="width:100%;" placeholder="Sonstige Bemerkungen">@if($current_offer_report[0]->filled_in == "yes"){{$current_offer_report[0]->microsite2_reports->question1->text}}@else{{ old('future_collaboration_text') }}@endif</textarea>
            <label for="characters left"><span class="comment">Verbleibende Zeichen: <span class="remain">1000</span></span></label>
          </div>
          <div class="float-clear"></div>
        </div><!--future collaboration ends here-->
        <label for="inquiries">Wie waren die Reaktionen Ihrer Gäste/Kunden auf Ihr Angebot?</label>
        <!--collective feedback-->
        <div class="form-group">
          ...
          <div class="form-yesno-area">
            <textarea name="collective_feedback_text" class="form-control microsite-textarea" id="" rows="3" style="width:100%;" placeholder="Sonstige Bemerkungen">@if($current_offer_report[0]->filled_in == "yes"){{$current_offer_report[0]->microsite2_reports->question2->text}}@else{{ old('collective_feedback_text') }}@endif</textarea>
            <label for="characters left"><span class="comment">Verbleibende Zeichen: <span class="remain">1000</span></span></label>
          </div>
        </div><!--collective feedback ends here-->
        <label for="inquiries">Wollen Sie der Redaktion noch etwas mitteilen? Haben Sie Vorschläge, wie wir die Zusammenarbeit oder den Erfolg verbessern können?</label>
        <!--overall success-->
        <div class="form-group">
          <div class="form-yesno" style="font-size:125%;">
            <div class="row">
              <label for="yesno-radio3" class="label-yes">Ja</label>
              <div class="checkBox">
            ...
            <div class="row">
              <label for="yesno-radio4" class="label-no">Nein</label>
              <div class="checkBox">
          ...
          <div class="form-yesno-area">
            <textarea name="overall_success_text" class="form-control microsite-textarea" id="" rows="3" style="width:100%;" placeholder="Sonstige Bemerkungen">@if($current_offer_report[0]->filled_in == "yes"){{$current_offer_report[0]->microsite2_reports->question3->text}}@else{{ old('overall_success_text') }}@endif</textarea>
            <label for="characters left"><span class="comment">Verbleibende Zeichen: <span class="remain">1000</span></span></label>
          </div>
        ...
        <div class="form-group">
          <div class="form-yesno" style="font-size:125%;">
            <div class="row">
              <label for="" style="visibility:hidden;" class="label-yes">Ja</label>
               <div class="checkBox">
          ...
          <div class="form-yesno-area">
            <label for="checkBox" style="cursor: pointer; line-height: 38px;">Ich könnte mir vorstellen, mein Angebot über den vereinbarten Angebotszeitraum hinaus zu verlängern.</label>
          </div>
