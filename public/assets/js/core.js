$(document).ready(function () {
    ...
    //*********************************** END CHAT POPUP*****************************
    jQuery('a.sub_task_link').on('click', function (e) {
        parent_li = $(this).parent('li').eq(0);
    ...
    jQuery('.page-sidebar li > a').on('click', function (e) {
        /*$('li.open').each(function (index, elm) {
            child_sub = $(this).children("ul.sub-menu");
            if(child_sub.css("display") == "none"){
                $(this).removeClass('open');
            }
        });*/
        if($(this).hasClass('task_link')){
        ...
        if($(this).hasClass('main_module_link')){
            $('.menu_bg').each(function(){
                $(this).removeClass('menu_bg');
            });
        }
        var parent = $(this).parent().parent();
        if($(this).parent().hasClass('open') && !($(this).parent().parent().parent('li').hasClass('open'))){
            // return;
        ...
        if(!$(this).parent().hasClass('dashboard_menu') && $('.dashboard_menu').hasClass('dashboard_active')){
        ...
        // debugger;
        /*if($(this).parent('li').hasClass('switch')){
            parent.children('li.open').children('.sub-menu').slideUp(200);
            $(this).parent('li').removeClass('switch');
        }*/

        //  parent.children('li').removeClass('active');//old
        var sub = jQuery(this).next();
        if (sub.is(":visible")) {
            jQuery('.arrow', jQuery(this)).removeClass("open");
            jQuery(this).parent().removeClass("active");
